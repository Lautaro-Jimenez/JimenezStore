...
class Juego {
    constructor(titulo, imagen, descripcion, genero, desarrollador, editor, franquicia, lanzamiento, link){
        // this.id = id;    // REVISAR POR QUÉ EL ID ME ROMPE LA PÁGINA
        this.titulo = titulo;
        this.imagen = imagen;
...
// LÓGICA DEL CARRITO QUE NO FUNCIONA - ACOMODAR!!

// function agregarAlCarrito(id) {
//     let agregarJuego = juegos.find(obj=> obj.id === id);
//     carrito.push(agregarJuego);
//     mostrarCarrito(agregarJuego);
//     actualizarCarrito();
// }

// function mostrarCarrito(agregarJuego) {

//     let div = document.createElement('div')
//     div.setAttribute('class', 'juegoEnCarrito')
//     div.innerHTML=`
//         <p>${agregarJuego.nombre}</p>
//         <button id="eliminar${agregarJuego.id}" class="boton-eliminar"><i class="fas fa-trash-alt"></i></button>
//         `;
//     contenedorCarrito.appendChild(div);

//     let btnEliminar = document.getElementById(`eliminar${agregarJuego.id}`)
//     btnEliminar.addEventListener('click',()=>{
//         btnEliminar.parentElement.remove()
//         carritoDeCompras = carritoDeCompras.filter(elemento => elemento.id !== agregarJuego.id)
